...
| 6 | [**Python Code Runner**](https://chromewebstore.google.com/detail/python-code-runner/keiealdacakpnbbljlmhfgcebmaadieg) | Python playground & IDE. Run Python code from any website with a right-click, analyze data, and create automated scripts. |
